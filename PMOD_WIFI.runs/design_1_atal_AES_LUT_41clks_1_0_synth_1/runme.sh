...
HD_PWD='C:/Xilinx/Vivado/MyProjects/PMOD_WIFI_CLIENT/PMOD_WIFI.runs/design_1_atal_AES_LUT_41clks_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_atal_AES_LUT_41clks_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_atal_AES_LUT_41clks_1_0.tcl
