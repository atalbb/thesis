...
HD_PWD='C:/Xilinx/Vivado/MyProjects/PMOD_WIFI_CLIENT/PMOD_WIFI.runs/design_1_axi_KEYbram_ctrl_0_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_KEYbram_ctrl_0_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_KEYbram_ctrl_0_bram_0.tcl
