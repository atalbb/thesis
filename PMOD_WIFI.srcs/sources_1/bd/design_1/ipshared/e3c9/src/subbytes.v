...
assign dataIn = (decrypt==0)?{data[127:120],data[87:80],data[47:40],data[7:0],data[95:88],data[55:48],data[15:8],data[103:96],data[63:56],data[23:16],data[111:104],data[71:64],data[31:24],data[119:112],data[79:72],data[39:32]}
     ...
     sbox q0( .a(dataIn[127:120]),.c(sb[127:120]),.decrypt(decrypt) );
     sbox q1( .a(dataIn[119:112]),.c(sb[119:112]),.decrypt(decrypt) );
     sbox q2( .a(dataIn[111:104]),.c(sb[111:104]),.decrypt(decrypt) );
     sbox q3( .a(dataIn[103:96]),.c(sb[103:96]),.decrypt(decrypt) );
     
     sbox q4( .a(dataIn[95:88]),.c(sb[95:88]),.decrypt(decrypt) );
     sbox q5( .a(dataIn[87:80]),.c(sb[87:80]),.decrypt(decrypt) );
     sbox q6( .a(dataIn[79:72]),.c(sb[79:72]),.decrypt(decrypt) );
     sbox q7( .a(dataIn[71:64]),.c(sb[71:64]),.decrypt(decrypt) );
     
     sbox q8( .a(dataIn[63:56]),.c(sb[63:56]),.decrypt(decrypt) );
     sbox q9( .a(dataIn[55:48]),.c(sb[55:48]),.decrypt(decrypt) );
     sbox q10(.a(dataIn[47:40]),.c(sb[47:40]),.decrypt(decrypt) );
     sbox q11(.a(dataIn[39:32]),.c(sb[39:32]),.decrypt(decrypt) );
     
     sbox q12(.a(dataIn[31:24]),.c(sb[31:24]),.decrypt(decrypt) );
     sbox q13(.a(dataIn[23:16]),.c(sb[23:16]),.decrypt(decrypt) );
     sbox q14(.a(dataIn[15:8]),.c(sb[15:8]),.decrypt(decrypt) );
     sbox q16(.a(dataIn[7:0]),.c(sb[7:0]),.decrypt(decrypt) );
