...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = atal_AES_LUT_41clks
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = atal_AES_LUT_41clks_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.1
 PARAMETER HW_INSTANCE = axi_DATAbram_ctrl_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.1
 PARAMETER HW_INSTANCE = axi_KEYbram_ctrl_0
END
