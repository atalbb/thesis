...
HD_PWD='C:/Xilinx/Vivado/MyProjects/myIps/ip_repo/edit_atal_AES_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log atal_AES_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source atal_AES_v1_0.tcl
